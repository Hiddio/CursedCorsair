...
public class LongShotCannonBallBehaviour : MonoBehaviour
{
    Rigidbody _rigidBody;
    float _projectileSpeed = 200f;
    float _projectileDamage = 20f;
    private void Awake()
    {
    ...
    private void Accelerate()
    {
        ...
        if(_projectileSpeed > 50f)
        _projectileSpeed = _projectileSpeed - 0.05f;
    }
